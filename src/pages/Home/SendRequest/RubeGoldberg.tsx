...
const RubeGoldberg = () => {
    ...
    function createGearsTimelines() {
      ...
      data.forEach((d, dIdx) => {
        ...
        let pathD =
          'M' +
          (gear.center.x +
            Math.cos(gear.angle - gear.toothAngle + gear.toothCurveAngle) *
              rOut) +
          ', ' +
          (gear.center.y +
            Math.sin(gear.angle - gear.toothAngle + gear.toothCurveAngle) *
              rOut) +
          ' ';
        for (
          let a = gear.angle;
        ...
        if (gear.hasHole) {
          ...
          pathD +=
            'M' + (gear.center.x - holeRadius) + ', ' + gear.center.y + ' ';
          pathD += `A ${holeRadius} ${holeRadius} 1 1 0 ${
            gear.center.x + holeRadius
          } ${gear.center.y}`;
          pathD += `A ${holeRadius} ${holeRadius} 1 1 0 ${
            gear.center.x - holeRadius
          } ${gear.center.y}`;
  ...
  return (
    <div className="rrrrrrr row mx-auto">
      <div className="container-rr">
        <div className="form-container-rb">
          ...
          <label className="form-row">
            <input type="checkbox" id="subscribe" name="subscribe" /> Clicking
            "Send" means ZSI will handle your data per our Privacy Notice.
          </label>
        ...
        >
          ...
          <g className="pull-system">
            ...
            <circle
              ...
              fill="#000"
            />
            <path className="submit-btn-connector" />
          </g>
          ...
          <g className="spiral-container">
            <path strokeWidth=".8" className="spiral-path" />
          </g>
