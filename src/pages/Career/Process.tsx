    ...
    <>
            ...
            <ul>
              ...
              <li>
                <div className="right_content">
                  <h2>Job Offer</h2>
                  <p>
                    If it's a match, we extend an offer for you to become part
                    of our ZSI family.
                  </p>
                </div>
                <div className="left_content">
      ...
      <div className="bg-primary py-5">
        <div className=" container text-center">
          ...
          "
          >
            You don't have to wait for a better future. You can invent a better
            now, For yourself And for the world. See what you could be a part of
            at ZSI.AI
          </h3>

          <a
            className="bg-white start_onboarding text-center text-dark text-lowercase mt-4 my-5"
            href="mailto:career@zsi.ai"
          >
            career@zsi.ai
          </a>
        </div>
