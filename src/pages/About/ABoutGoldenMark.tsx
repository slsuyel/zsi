  ...
  return (
    <>
      <div className="row mx-auto my-5">
        <div className="col-md-7 p-0 my-2">
          <img
            loading="lazy"
            src={gmark}
            alt=""
        ...
        <div className="col-md-5 about-g-mark my-2 animated-gradient">
          <h2 className="">
            {" "}
            We are a global software Engineering company of GoldenMark Group in
            America.
          </h2>
          <p>
            In 1995 Our Parent Company Optimum International Limited Has Started
            Its Journey In Bangladesh And Established As A Trusted Global
            Partner.
          </p>
