...
//           <p className="mb-0">Ceo Of Company</p>
//         </div>
...
const Clients = (props: ClientsProps) => {
  ...
  const next = () =>
    setActiveSlide((prevActiveSlide) =>
      prevActiveSlide < props.data.length - 1 ? prevActiveSlide + 1 : 0
    );

  const prev = () =>
    setActiveSlide((prevActiveSlide) =>
      prevActiveSlide > 0 ? prevActiveSlide - 1 : props.data.length - 1
    );
  ...
  const nextSlideBgColor =
    activeSlide < props.data.length - 1
      ? props.data[activeSlide + 1].bgColor
      : props.data[0].bgColor; // Wrap to first slide color
  const prevSlideBgColor =
    activeSlide > 0
      ? props.data[activeSlide - 1].bgColor
      : props.data[props.data.length - 1].bgColor; // Wrap to last slide color
